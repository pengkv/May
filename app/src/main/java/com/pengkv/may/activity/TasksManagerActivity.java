...
import com.pengkv.may.config.Constant;
import com.pengkv.may.config.MayApplication;
import com.pengkv.may.util.FileDownloadUtils;
...
public class TasksManagerActivity extends AppCompatActivity {
        ...
        public void updateDownloading(final int status, final long sofar, final long total) {
            ...
            switch (status) {
                ...
                case FileDownloadStatus.progress:
                    ...
                    break;
                default:
                    taskStatusTv.setText(MayApplication.CONTEXT.getString(
    ...
    private static class TasksManagerDBController {
        ...
        private TasksManagerDBController() {
            TasksManagerDBOpenHelper openHelper = new TasksManagerDBOpenHelper(MayApplication.CONTEXT);
        ...
        public TasksManagerModel addTask(final String url, final String path) {
            ...
            TasksManagerModel model = new TasksManagerModel();
            model.setId(id);
            model.setName(MayApplication.CONTEXT.getString(R.string.tasks_manager_demo_name, id));
            model.setUrl(url);
            model.setPath(path);
